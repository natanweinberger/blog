...
This isn't a post extolling the virtues of writing good code. If you're reading this, you probably agree that good code is better than bad code. However, I wanted to write down some thoughts about *when it actually matters*.

When does writing good code actually pay off?

## What is “good”?

There’s obviously no right answer, but I think we can all agree that there’s some combination of these qualities:
    
- Naming
- Structure
- Explicitness
    
All of these things really stem from one fundamental parent idea: **humans are the ones reading and writing the code**.
...
However, right as the code is deployed to production, there’s really no noticeable difference. In those moments, the only determining factor is whether or not the computer understands what’s been written. Humans are only important in reading and modifying code, not in executing it.

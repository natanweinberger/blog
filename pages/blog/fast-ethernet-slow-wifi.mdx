...
_If you're not sure which one to choose, don't worry. Pick one and continue with the remaining of the steps - if you picked the wrong one, the network won't be broadcast to other devices. Come back to this step and cycle through the rest of the list._
...
<Figure imageSrc={connectToSharedWifi} caption="The new network is visible from another laptop"/>
